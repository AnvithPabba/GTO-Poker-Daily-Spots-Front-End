...
export function ChallengePage() {
  ...
  return <section className="challenge-page">
    ...
    <div className="game-layout"><div className="game-column">
      ...
      <div className="answer-header"><p className="eyebrow">Your strategy</p><h2 id="answer-heading">{featured}</h2><p>{answering ? "Set a percentage for each move." : "Finish the history to answer."}</p></div>
